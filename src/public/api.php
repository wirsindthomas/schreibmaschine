...
require_once APPLICATION_PATH . '/services/Metaweblog.php';
require_once APPLICATION_PATH . '/services/Blogger.php';
...
/**
 * @todo only bootstrap needed modules
 */
$application->bootstrap();

/**
 * Setting up XmlRpcServer
 */
$server = new \Zend\XmlRpc\Server();
$server->setClass('WST\Schreibmaschine\Service\Metaweblog', 'metaWeblog');
$server->setClass('WST\Schreibmaschine\Service\Blogger', 'blogger');
